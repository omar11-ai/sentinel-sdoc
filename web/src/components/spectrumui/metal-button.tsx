/**
 * Spectrum UI — MetalButton (vendored, MIT)
 *
 ...
 * surface, sizes, and class-based dark/light detection so the ring matches the
 * app's `.dark` theme instead of only the OS preference.
 *
 * @example
 * <MetalButton preset="silver">Analyze</MetalButton>
 */
