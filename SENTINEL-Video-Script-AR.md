...
## 🎯 جملة دور الـAI — تُقال حرفيًا في مشهد الـAI (وفي سلايد الـArchitecture)
> **السؤال الحقيقي اللي هيُسأل:** "طب لو شلت الـAI بالكامل، إيه اللي هيتغير؟"
> **الإجابة المكتوبة (قولها بنفس الجملة دي):**
> «على بيانات البطولة دي، محرك القواعد لوحده بيوصل للسقف — وإحنا نشرنا ده بإيدينا في تقرير التحقق، وده إثبات إن النواة الحتمية آمنة وماشيّة الصح. الـAI عندنا مش ديكور: بيدخل بالظبط لما اللغة تضلّل — عنوان متعمّد إنه يضلل، أو تسمية حقل عمرها ما عدّت علينا — وبيقفل كمان الفحص اللايف اللي بتشوفه قدامك. القواعد بتحسم الواضح، والـAI بيمدّ النظام لأوراق ما شافهاش قبل كده.»

**ممنوع تقول (هتضرب في معيار AI Integration):**
- ❌ "الـAI هو اللي بيرفع الدقة" / "من غير الـAI الدقة هتقع" — غلط على البيانات دي ومفيش دليل
- ❌ "نستخدم AI متقدم في كل مرحلة" — أول سطر في الـtrace هيفضحها
- ✅ الصياغة الآمنة: "rules decide the clear cases; AI is engaged precisely when language misleads"
